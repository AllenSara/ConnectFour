# Use this file to have a user play against the trained model. Implements graphics for UX
...
while not game_over:
    ...
    if turn == AI and not game_over:
        reshaped_state = np.array(board).reshape(1, 6, 7, 1).copy()
        ...
        for action_test in enumerate(action_weights_sorted):
            if action_test[1][0] in get_valid_locations(board):
                col = action_test[1][0]
                row = get_next_open_row(board, col)
